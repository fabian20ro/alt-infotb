...
<nav class="drawer" class:open aria-label="Meniu navigare">
	<div class="drawer-content">
		...
		<div class="build-badge">
			<a href="https://github.com/fabian20ro/alt-infotb/actions/workflows/deploy.yml"
				 target="_blank" rel="noopener noreferrer">
				<img src="https://github.com/fabian20ro/alt-infotb/actions/workflows/deploy.yml/badge.svg"
